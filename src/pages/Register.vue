    ...
    <el-container style="height: 650px; border: 1px solid #eee;">
      ...
      <el-container>
        <el-header style="width: 100%;text-align: right;font-size: 16px;">
          <i @click="click" class="el-icon-menu menu" style="float: left;margin-top: 20px;font-size: 20px;cursor: pointer"></i>
          <span>{{username}}</span>
    ...
    methods:{
      showMenu:function(){
        ...
        if(this.username === "李有山"  || this.username === "牛红珍" || this.username === "李国正"
          || this.username === "陈红喜" || this.username === "裴化民"){
          this.$router.push({
            path:"/product"
          })
        }else{
      ...
      showBusiness:function(){
        // console.log(this.name)
        if(this.username === "李有山"  || this.username === "牛红珍" || this.username === "李国正"
        || this.username === "李有臣" || this.username === "翟海军"){
          this.$router.push({
            path:"/business"
          })
        }else{
